  ...
  return (
    <section>
      <div className="fixed left-85 top-56 ml-40">
        <button className="w-48 h-10 ml-80 pl-1 pt-1 text-lg mt-7 focus:outline-none rounded-lg bg-blue-500">
          Add/Edit Faculty
        </button>
      </div>
      <div className="flex justify-center item-center">
        <div className="fixed overflow-auto w-280 top-80 left-120 h-100 pb-120 border-1 border-black rounded-2xl text-5 text-left">
          ...
          <button
            className="absolute bg-blue-500 rounded-md w-20 h-auto left-110 top-260 text-white text-22"
            onClick={handleSave}
          >
            Save
          </button>
          <button className="absolute bg-blue-500 rounded-md w-20 h-auto right-60 top-260 text-white text-22">
            Edit
          </button>
